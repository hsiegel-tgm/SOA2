...
\centering
\includegraphics[width=1.0\textwidth]{images/page395}
	\caption{http://www.tecchannel.de/webtechnik/soa/458074/nachrichten_verschicken_mit_soap_die_soap_spezifikation/index4.html}
...
\end{lstlisting}
\\ In the example above, a GetStockPrice request is sent to a server. The request has a StockName parameter, and a Price parameter that will be returned in the response. The namespace for the function is defined in "http://www.example.org/stock".\cite{soap}\\
\newpage
