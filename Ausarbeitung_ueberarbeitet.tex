...
\begin{figure}[here!]
	\centering
	\includegraphics[width=0.4\textwidth]{images/screenshot2}
...
\subsubsection{The SOA Triangle} %TODO crosscheck
...
It manages the integration of all compnents and offers an standard user interface of some kind. \cite{esbdef}\\
